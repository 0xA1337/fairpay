  ...
  return (
    <>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Crowdfund Your Sports Dream
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Unlock your sports potential with our innovative crowdfunding platform. Connect
                    with supporters and turn your passion into reality.
                  </p>
                </div>
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Crowdfunding Platform</h3>
                      <p className="text-muted-foreground">
                        Easily create and manage your crowdfunding campaign to connect with
                        supporters on Farcaster.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Expand your network and connect with industry professionals, mentors, and
                        your fans.
                      </p>
                    </div>
                  </li>
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Hear from athletes who have achieved their goals with the help of our platform.
              </p>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 justify-center items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2024 Fairpay.</p>
      </footer>
    </>
  );
}
